...
Este estado es el más sencillo y factible de conseguir, y es el primer paso para conseguir la [independencia financiera](/). Con *sencillo* no quiero decir que no vaya a costarnos nada. Claro que costará. Pero para conseguir la seguridad financiera no se necesitan grandes conocimientos financieros, sino un compromiso con nosotros mismos.

Nuestro objetivo con la seguridad financiera es **dejar que nuestras inversiones cubran nuestros gastos básicos**. Esto no quiere decir que podremos *dejar de trabajar* (ahí entra la independencia financiera), sino que no tendremos que preocuparnos más de nuestros gastos vitales, y podremos dedicar la mayor parte de los ingresos de nuestro trabajo para gastos discrecionales o para prepararnos para el siguiente paso.
...
Un fondo global como el iShares MSCI World ETF ha producido desde su creación en 2012 un retorno medio anual del 10.96%. Un retorno del 10.96% está muy bien, pero tengamos en cuenta que el fondo se creó justo **después** de una de las peores crisis financieras que recordamos. Otro fondo global, como el [Vanguard Global Equity](https://personal.vanguard.com/us/funds/snapshot?FundId=0129&FundIntExt=INT) lleva bastante más tiempo, lo que nos permite filtrar desde un año **antes** de la crisis hasta dia de hoy, donde ha conseguido una media de 3.90%. Es importante no ser demasiado optimista. Más info en [¿qué intereses puedo esperar?](/)
